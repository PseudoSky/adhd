...
- [x] dag.json (7 nodes: dag-schema, dag-types, dag-engine, audit-foundation, code-review, audit-final, docs-and-publish)
- [x] state.json (current_state: dag-schema, all pending)
- [x] references.json
- [x] state-machine.md
- [x] contexts/_shared.md
- [x] contexts/dag-schema.md
- [x] contexts/dag-types.md
