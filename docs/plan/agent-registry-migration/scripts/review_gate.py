#!/usr/bin/env python3
"""
review_gate.py — code-review gate for the agent-registry-migration plan.
...
audit_*.py oracle cannot (e.g. an import that drives mocks instead of the real registry stores, a round-trip equivalence gate that does not block removal, or a removal step that is not gated on an all-PASS report).

Usage:
  python3 docs/plan/agent-registry-migration/scripts/review_gate.py
