#!/usr/bin/env python3
"""
review_gate.py — code-review gate for the agent-mcp-refactor plan.
...
audit_*.py oracle cannot (e.g. an AgentStore retirement that leaves a competing source of truth, a systemPrompt compat-shim that diverges from the recorded policy, or a composed_prompt cache FK that does not match the decided session topology).

Usage:
  python3 docs/plan/agent-mcp-refactor/scripts/review_gate.py
