...
```text
added:    []
modified: ["63 project manifests (62 target-owning projects + the workspace root)","nx.json where non-default target options must be carried into inference"]
