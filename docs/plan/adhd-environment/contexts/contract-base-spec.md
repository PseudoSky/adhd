...
- **Delta Spec:**
  ...
  2. Write `spec/cross-language-test-vectors.json` with contentHash test vector: `{b:"2",a:"1"}` → `"sha256-9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08"`
