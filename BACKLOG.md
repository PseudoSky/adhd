...
**Status:** OPEN — release config is in place and dry-run-valid, but "changed-only publish" is **not yet functional or proven**. Blocks any claim that publishing is "fully done."
**Citations:** [main@a6117858, claude, env/release-verification, 1: `git tag -l` (0 matching `@[0-9]`) + `npx nx release version [patch|--] --dry-run` output 2026-07-20; nx.json:227-273 release config]
