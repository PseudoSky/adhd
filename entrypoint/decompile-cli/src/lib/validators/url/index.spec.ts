...
function expectEqual(
  test: jest.Expect,
  actual: Parameters<jest.Expect>[0],
  expected?: Parameters<jest.Expect>[0]
) {
...
describe('url', () => {
  it('isUrl', () => {
    ...
    expectEqual(
      expect,
      isValidUrl('https://user:password@www.sindresorhus.com/@user'),
      true
    );
    expectEqual(
      expect,
      isValidUrl('www.sindresorhus.com?foo=bar&utm_medium=test&ref=test_ref'),
      false
    );
    expectEqual(
      expect,
      isValidUrl(
        'http://www.sindresorhus.com?foo=bar&utm_medium=test&ref=test_ref'
      ),
      true
    );
  ...
  it('main', () => {
    ...
    expectEqual(
      expect,
      normalizeUrl('sindresorhus.com', { defaultProtocol: 'https:' }),
    ...
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com:80'),
      'http://sindresorhus.com'
    );
    expectEqual(
      expect,
      normalizeUrl('https://sindresorhus.com:443'),
      'https://sindresorhus.com'
    );
    expectEqual(
      expect,
      normalizeUrl('ftp://sindresorhus.com:21'),
    ...
    expectEqual(
      expect,
      normalizeUrl('http://www.www.sindresorhus.com'),
      'http://www.www.sindresorhus.com'
    );
    expectEqual(
      expect,
      normalizeUrl('www.sindresorhus.com'),
      `${scheme}//sindresorhus.com`
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/foo/'),
      'http://sindresorhus.com/foo'
    );
    expectEqual(
      expect,
      normalizeUrl('sindresorhus.com/?foo=bar baz'),
      `${scheme}//sindresorhus.com/?foo=bar+baz`
    );
    expectEqual(
      expect,
    ...
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/%7Efoo/'),
      'http://sindresorhus.com/~foo'
    );
    expectEqual(
      expect,
    ...
    expectEqual(
      expect,
      normalizeUrl('êxample.com'),
      `${scheme}//xn--xample-hva.com`
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/?b=bar&a=foo'),
      'http://sindresorhus.com/?a=foo&b=bar'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/?foo=bar*|<>:"'),
      'http://sindresorhus.com/?foo=bar*%7C%3C%3E%3A%22'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com:5000'),
    ...
    expectEqual(
      expect,
      normalizeUrl('//sindresorhus.com:443/', { normalizeProtocol: false }),
      '//sindresorhus.com'
    );
    expectEqual(
      expect,
    ...
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/foo#bar', { stripHash: true }),
      'http://sindresorhus.com/foo'
    );
    expectEqual(
      expect,
  ...
  it('stripAuthentication option', () => {
    ...
    expectEqual(
      expect,
      normalizeUrl('https://user:password@www.sindresorhus.com'),
      'https://sindresorhus.com'
    );
    expectEqual(
      expect,
      normalizeUrl('https://user:password@www.sindresorhus.com/@user'),
    ...
    expectEqual(
      expect,
      normalizeUrl('http://user:password@www.sindresorhus.com', options),
      'http://user:password@sindresorhus.com'
    );
    expectEqual(
      expect,
      normalizeUrl('https://user:password@www.sindresorhus.com', options),
      'https://user:password@sindresorhus.com'
    );
    expectEqual(
      expect,
      normalizeUrl('https://user:password@www.sindresorhus.com/@user', options),
      'https://user:password@sindresorhus.com/@user'
    );
    expectEqual(
      expect,
      normalizeUrl('user:password@sindresorhus.com', options),
      `${scheme}//user:password@sindresorhus.com`
    );
    expectEqual(
      expect,
  ...
  it('stripProtocol option', () => {
    ...
    expectEqual(
      expect,
      normalizeUrl('http://www.sindresorhus.com', options),
      'sindresorhus.com'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com', options),
      'sindresorhus.com'
    );
    expectEqual(
      expect,
      normalizeUrl('https://www.sindresorhus.com', options),
      'sindresorhus.com'
    );
    expectEqual(
      expect,
      normalizeUrl('//www.sindresorhus.com', options),
      'sindresorhus.com'
    );
    expectEqual(
      expect,
  ...
  it('removeQueryParameters option', () => {
    ...
    expectEqual(
      expect,
      normalizeUrl('www.sindresorhus.com?foo=bar&utm_medium=test'),
      `${scheme}//sindresorhus.com/?foo=bar`
    );
    expectEqual(
      expect,
      normalizeUrl('http://www.sindresorhus.com', options),
    ...
    expectEqual(
      expect,
      normalizeUrl('www.sindresorhus.com?foo=bar', options),
      `${scheme}//www.sindresorhus.com/?foo=bar`
    );
    expectEqual(
      expect,
      normalizeUrl(
  ...
  it('forceHttp option', () => {
    ...
    expectEqual(
      expect,
      normalizeUrl('//sindresorhus.com', options),
      'http://sindresorhus.com'
    );
  });
  ...
  it('removeTrailingSlash option', () => {
    ...
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/redirect/', options),
      'http://sindresorhus.com/redirect/'
    );
    expectEqual(
      expect,
  ...
  it('removeDirectoryIndex option', () => {
    ...
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/index.html'),
      'http://sindresorhus.com/index.html'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/index.html', options1),
      'http://sindresorhus.com'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/index.htm', options1),
      'http://sindresorhus.com/index.htm'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/index.php', options1),
      'http://sindresorhus.com'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/path/index.html'),
      'http://sindresorhus.com/path/index.html'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/path/index.html', options1),
      'http://sindresorhus.com/path'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/path/index.htm', options1),
      'http://sindresorhus.com/path/index.htm'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/path/index.php', options1),
      'http://sindresorhus.com/path'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/foo/bar/index.html', options1),
      'http://sindresorhus.com/foo/bar'
    );
    ...
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/index.html', options2),
      'http://sindresorhus.com'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/index/index.html', options2),
      'http://sindresorhus.com/index'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/remove.html', options2),
      'http://sindresorhus.com'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/defaulexpect', options2),
      'http://sindresorhus.com/defaulexpect'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/index.php', options2),
      'http://sindresorhus.com'
    );
    ...
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/index.html', options3),
      'http://sindresorhus.com'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/index.htm', options3),
      'http://sindresorhus.com'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/index.php', options3),
      'http://sindresorhus.com'
    );
  });
  ...
  it('removeTrailingSlash and removeDirectoryIndex options)', () => {
    ...
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/path/', options1),
      'http://sindresorhus.com/path'
    );
    expectEqual(
      expect,
    ...
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/foo/#/bar/', options1),
      'http://sindresorhus.com/foo#/bar/'
    );
    ...
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/path/', options2),
      'http://sindresorhus.com/path/'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/path/index.html', options2),
      'http://sindresorhus.com/path/'
    );
    expectEqual(
      expect,
  ...
  it('sortQueryParameters option', () => {
    ...
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/?a=Z&b=Y&c=X&d=W', options1),
      'http://sindresorhus.com/?a=Z&b=Y&c=X&d=W'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/?b=Y&c=X&a=Z&d=W', options1),
      'http://sindresorhus.com/?a=Z&b=Y&c=X&d=W'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/?a=Z&d=W&b=Y&c=X', options1),
      'http://sindresorhus.com/?a=Z&b=Y&c=X&d=W'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/', options1),
      'http://sindresorhus.com'
    );
    ...
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/?a=Z&b=Y&c=X&d=W', options2),
      'http://sindresorhus.com/?a=Z&b=Y&c=X&d=W'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/?b=Y&c=X&a=Z&d=W', options2),
      'http://sindresorhus.com/?b=Y&c=X&a=Z&d=W'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/?a=Z&d=W&b=Y&c=X', options2),
      'http://sindresorhus.com/?a=Z&d=W&b=Y&c=X'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com/', options2),
      'http://sindresorhus.com'
    );
  });
  ...
  it('remove duplicate pathname slashes', () => {
    ...
    expectEqual(
      expect,
      normalizeUrl('//sindresorhus.com//foo', { normalizeProtocol: false }),
      '//sindresorhus.com/foo'
    );
    expectEqual(
      expect,
      normalizeUrl('http://sindresorhus.com:5000///foo'),
  ...
  it('data URL', () => {
    ...
    expectEqual(
      expect,
      normalizeUrl('data:;charset=us-ascii,foo'),
      'data:,foo'
    );
    ...
    expectEqual(
      expect,
      normalizeUrl('data:TEXT/HTML,foo'),
      'data:text/html,foo'
    );
    ...
    expectEqual(
      expect,
      normalizeUrl('data:;base64, Zm9v #foo #bar'),
    ...
    expectEqual(
      expect,
      normalizeUrl('data:,sindresorhus.com/', options),
      'data:,sindresorhus.com/'
    );
    expectEqual(
      expect,
      normalizeUrl('data:,sindresorhus.com/index.html', options),
    ...
    expectEqual(
      expect,
      normalizeUrl('data:,www.sindresorhus.com', options),
