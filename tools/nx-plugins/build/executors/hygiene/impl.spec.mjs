...
// real `publish-hygiene` executor end-to-end, which wraps its work in
...
// (here: a mocked child boundary, so the wall window is single-digit-ms). On a
...
// `tools/nx-plugins/lib/metrics.spec.mjs` — this file only asserts hygiene
// orchestration + metrics-record shape, so disable the guard here (metrics
