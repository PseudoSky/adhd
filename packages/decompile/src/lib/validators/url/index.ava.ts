...
import {isValidUrl, normalizeUrl, ErrorTypes, defaultOptions} from './';
...
test('isUrl', (t)=> {
  t.is(isValidUrl('HTTP://sindresorhus.com'), true);
  t.is(isValidUrl('ftp://sindresorhus.com:21'), true);
  t.is(isValidUrl('http://www.sindresorhus.com'), true);
  t.is(isValidUrl('https://user:password@www.sindresorhus.com/@user'), true);
  t.is(isValidUrl('www.sindresorhus.com?foo=bar&utm_medium=test&ref=test_ref'), false);
  t.is(isValidUrl('http://www.sindresorhus.com?foo=bar&utm_medium=test&ref=test_ref'), true);

  t.is(isValidUrl('sindresorhus.com.'), false);
  t.is(isValidUrl('[www].com'), false);
  t.is(isValidUrl('.'), false);
  t.is(isValidUrl('./'), false);
  // t.is(normalizeUrl('.', {returns:'url'}),'asdf')
  // t.is(normalizeUrl('./',{returns:'url'}),'asdf')
  t.is(isValidUrl('./index.js'), false);
  t.is(isValidUrl('/'), false);
  t.is(isValidUrl('/index.js'), false);
  t.is(isValidUrl('<root>\\--'), false);
});

test('main', (t) => {
  t.is(normalizeUrl('sindresorhus.com'), `${scheme}//sindresorhus.com`);
  t.is(normalizeUrl('sindresorhus.com '), `${scheme}//sindresorhus.com`);
  t.is(normalizeUrl('sindresorhus.com.'), `${scheme}//sindresorhus.com`);
  t.is(normalizeUrl('SindreSorhus.com'), `${scheme}//sindresorhus.com`);
  ...
  t.is(normalizeUrl('www.com'), `${scheme}//www.com`);
  t.is(normalizeUrl('http://www.www.sindresorhus.com'), 'http://www.www.sindresorhus.com');
  t.is(normalizeUrl('www.sindresorhus.com'), `${scheme}//sindresorhus.com`);
  t.is(normalizeUrl('http://sindresorhus.com/foo/'), 'http://sindresorhus.com/foo');
  t.is(normalizeUrl('sindresorhus.com/?foo=bar baz'), `${scheme}//sindresorhus.com/?foo=bar+baz`);
  ...
  t.is(normalizeUrl('http://sindresorhus.com/?'), 'http://sindresorhus.com');
  t.is(normalizeUrl('êxample.com'), `${scheme}//xn--xample-hva.com`);
  ...
  t.is(normalizeUrl('//sindresorhus.com:443/', {normalizeProtocol: false}), '//sindresorhus.com');
...
test('stripAuthentication option', (t) => {
  ...
  t.is(normalizeUrl('user:password@sindresorhus.com'), `${scheme}//sindresorhus.com`);
  ...
  t.is(normalizeUrl('user:password@sindresorhus.com', options), `${scheme}//user:password@sindresorhus.com`);
...
test('stripWWW option', (t) => {
  ...
  t.is(normalizeUrl('www.sindresorhus.com', options), `${scheme}//www.sindresorhus.com`);
...
test('removeQueryParameters option', (t) => {
  ...
  t.is(normalizeUrl('www.sindresorhus.com?foo=bar&utm_medium=test'), `${scheme}//sindresorhus.com/?foo=bar`);
  t.is(normalizeUrl('http://www.sindresorhus.com', options), 'http://www.sindresorhus.com');
  t.is(normalizeUrl('www.sindresorhus.com?foo=bar', options), `${scheme}//www.sindresorhus.com/?foo=bar`);
  t.is(normalizeUrl('www.sindresorhus.com?foo=bar&utm_medium=test&ref=test_ref', options), `${scheme}//www.sindresorhus.com/?foo=bar`);
});
...
test('forceHttp option with forceHttps', (t) => {
  ...
  t.is(e.message, 'The `forceHttp` and `forceHttps` options cannot be used together');
});
...
test('invalid urls', (t) => {
  let e;
  e = t.throws(() => normalizeUrl('http://'));
  t.is(e.message, 'Invalid URL: http://');

  e = t.throws(() => normalizeUrl('/'));
  t.is(e.message, 'Invalid URL: /');

  e = t.throws(() => normalizeUrl('/relative/path/'));
  t.is(e.message, 'Invalid URL: /relative/path/');
});
...
test('deprecated options', (t) => {
  let e;
  e = t.throws(() => normalizeUrl('', {normalizeHttps: true}));
  t.is(e.message, 'options.normalizeHttps is renamed to options.forceHttp');
  e = t.throws(() => normalizeUrl('', {normalizeHttp: true}));
  t.is(e.message, 'options.normalizeHttp is renamed to options.forceHttps');
  e = t.throws(() => normalizeUrl('', {stripFragment: true}));
  t.is(e.message, 'options.stripFragment is renamed to options.stripHash');
});

test('data URL', (t) => {
  // Invalid URL.
  const e = t.throws(() => normalizeUrl('data:'));
  t.is(e.message, 'Invalid URL: data:');
