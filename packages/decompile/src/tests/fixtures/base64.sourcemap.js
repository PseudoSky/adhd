                    ...
                    return regeneratorRuntime.async(function _callee$(_context) {
                        while (1) {
                            ...
                            case 0:
                                ...
                                _this.camera = new _expoThree.THREE.PerspectiveCamera(50,width / height,0.1,10000);
                    ...
                    return regeneratorRuntime.async(function _callee2$(_context2) {
                        while (1) {
                            ...
                            case 0:
                                ...
                                _this.scene.background = new _expoThree.THREE.Color(0x999999);
                                _this.scene.fog = new _expoThree.THREE.FogExp2(0xcccccc,0.002);
                ...
                _this.setupCubeAsync = function _callee3() {
                    ...
                    return regeneratorRuntime.async(function _callee3$(_context3) {
                        while (1) {
                            ...
                            case 0:
                                someRemoteUrl = 'https://www.biography.com/.image/t_share/MTE5NDg0MDU0ODczNDc0NTc1/ben-affleck-9176967-2-402.jpg';
                                _context3.next = 3;
                                return regeneratorRuntime.awrap(_expoThree.default.loadAsync(someRemoteUrl));

                            case 3:
                                texture = _context3.sent;
                                _this.box = new _expoThree.THREE.Mesh(new _expoThree.THREE.CubeGeometry(1,1,1),new _expoThree.THREE.MeshPhongMaterial({
                                    map: texture
                                }));
