...
export const POLICY_TEMPLATES: readonly PolicyTemplateSeedRow[] = [
...

  {
    ...
    type: 'safety',
    description:
      'Default skeptic posture: NEEDS-WORK unless evidence confirms each criterion',
    rules: {
...

  {
    ...
    type: 'quality',
    description:
      'Block verdict if required evidence fields are absent or empty',
    rules: {
...

  {
    ...
    type: 'quality',
    description:
      'Block duplicate agent commits above 0.85 similarity threshold',
    rules: {
...

  {
    ...
    type: 'permission',
    description:
      'Restrict agent to read-only tool access; forbid compute tools',
    rules: {
...

  {
    ...
    type: 'compliance',
    description:
      'Require passing phase gate before ticket creation for next phase',
    rules: {
