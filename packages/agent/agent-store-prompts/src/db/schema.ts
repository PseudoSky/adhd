...
export const taxonomyCategoriesTable = sqliteTable(
  ...
  (t) => ({
    positionIdx: index('registry_taxonomy_categories_position_idx').on(
      t.position
    ),
    parentIdx: index('registry_taxonomy_categories_parent_idx').on(
      t.parentSlug
    ),
  })
);
...
export const componentUsageTable = sqliteTable(
  ...
  (t) => ({
    ...
    useCaseIdx: index('registry_component_usage_use_case_idx').on(
      t.useCaseSlug
    ),
    componentIdx: index('registry_component_usage_component_idx').on(
      t.componentSlug
    ),
  })
);
...
export const contextRulesTable = sqliteTable(
  ...
  (t) => ({
    ...
    componentIdx: index('registry_context_rules_component_idx').on(
      t.componentSlug
    ),
  })
);
