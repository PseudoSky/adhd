...
export const models = sqliteTable(
  'provider_models',
  {
    ...
    promptCaching: integer('prompt_caching', { mode: 'boolean' })
      .notNull()
      .default(false),
    extendedThinking: integer('extended_thinking', { mode: 'boolean' })
      .notNull()
      .default(false),
  ...
  (table) => [index('idx_provider_models_pricing_tier').on(table.pricingTier)]
);
