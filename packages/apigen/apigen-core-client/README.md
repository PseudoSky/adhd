...
import type { GeneratedSchemas, ComposedSchemas, ExportMode, GenerateSchemasOptions, PluginInput, PluginOutput, RunInput, OutputPlugin, Logger } from '@adhd/apigen-core-client';
```
...
- **Persistent tier (process lifetime)** — Projects, generators, and schema fragments are
  ...
  Invalidation caveat: versions track the _entry_ file; an edit to a file it merely
