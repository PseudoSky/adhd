...
/**
 * Dedicated E2E lane for `apigen-core-client`.
 *
 * The resource-consuming suites — the CPU-heavy real ts-morph/TypeScript
 * compilation suites, plus the two `spawnSync` subprocess specs — were
