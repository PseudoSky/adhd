...
This was a version bump only for apigen-plugin-openapi to align it with other projects, there were no code changes.
...
- **apigen-plugin-openapi:** sync @adhd/apigen-codegen-openapi range to installed 0.1.2
