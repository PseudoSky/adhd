...
export const VALID_OPS_BY_KIND: Record<string, ReadonlySet<ShapeOpType>> = {
  ...
  const: new Set<ShapeOpType>([
    'add-var',
    'remove-var',
    'rename-var',
    'change-default',
  ]),
  config: new Set<ShapeOpType>([
    'set-key',
    'remove-key',
    'rename-key',
    'add-entry',
