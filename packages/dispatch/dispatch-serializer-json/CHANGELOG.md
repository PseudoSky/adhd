...
This was a version bump only for dispatch-serializer-json to align it with other projects, there were no code changes.
...
- **dispatch-serializer-json:** JSON file serializer with atomic writes
