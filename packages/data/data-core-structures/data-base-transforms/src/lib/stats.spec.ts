...
describe('transforms', () => {
  it('should work', () => {
    ...
    expect(stats.roundToIncrement(1.26, 0.5)).toEqual(1.5);
    expect(stats.minMax([1, 2, 3, 4, 5])).toEqual({ max: 5, min: 1 });
    ...
    expect(stats.histogram([1, 2, 3, 4, 5])).toEqual(
      new Map([
        [1, 1],
        [2, 1],
        [3, 1],
    ...
    expect([...new stats.Counter([1, 2, 3, 4, 5]).entries()]).toEqual([
      [1, 1],
      [2, 1],
      [3, 1],
      [4, 1],
