...
This project is indexed by GitNexus as **adhd** (23119 symbols, 35000 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
